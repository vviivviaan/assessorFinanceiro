"""Stub file for reflex_components_dataeditor/dataeditor.py"""
...
class DataEditor(NoSSRComponent):
    ...
    def create(
        cls,
        *children,
        extended_cell_types: bool | None = False,
        ...
        | None = None,
        range_select: Literal["cell", "multi-cell", "multi-rect", "none", "rect"]
        | Var[Literal["cell", "multi-cell", "multi-rect", "none", "rect"]]
        | None = None,
        row_select: Literal["multi", "none", "single"]
        | Var[Literal["multi", "none", "single"]]
        | None = None,
        ...
        range_selection_blending: Literal["exclusive", "mixed"]
        | Var[Literal["exclusive", "mixed"]]
        | None = None,
        column_selection_blending: Literal["exclusive", "mixed"]
        | Var[Literal["exclusive", "mixed"]]
        | None = None,
        ...
        custom_renderers: Any | Var[Any] | None = None,
        ...
        on_grid_selection_change: EventType[()] | EventType[GridSelection] | None = None,
        ...
        **props,
        ...
        Args:
            *children: The children of the data editor.
            ...
            range_select: Allow range selections. ("none", "cell", "rect", "multi-cell", "multi-rect").
            row_select: Allow row selections. ("none", "single", "multi").
            ...
            theme: global theme
            grid_selection: The current grid selection state (columns, rows, and current cell/range). Must be used when on_grid_selection_change is used otherwise updates will not be reflected in the grid.
            show_search: Shows search bar.
            custom_renderers: Custom cell renderers
