"""Stub file for reflex_components_recharts/charts.py"""
...
from reflex_base.event import EventHandler, EventType, PointerEventInfo
...
class RadarChart(ChartBase):
    ...
    def create(
        cls,
        *children,
        on_mouse_move: EventHandler | None = None,
        data: Sequence[dict[str, Any]] | Var[Sequence[dict[str, Any]]] | None = None,
        margin: Var[dict[str, Any]] | dict[str, Any] | None = None,
